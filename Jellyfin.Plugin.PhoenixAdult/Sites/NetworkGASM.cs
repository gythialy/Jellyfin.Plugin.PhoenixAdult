...
namespace PhoenixAdult.Sites
{
    public class NetworkGASM : IProviderBase
    {
        ...
        private readonly Dictionary<string, string> cookies = new Dictionary<string, string> { { "WarningModal", "true" } };
        ...
        public async Task<List<RemoteSearchResult>> Search(int[] siteNum, string searchTitle, DateTime? searchDate, CancellationToken cancellationToken)
        {
            ...
            {
                string searchUrl = Helper.GetSearchSearchURL(siteNum) + this.Slugify(searchTitle);
