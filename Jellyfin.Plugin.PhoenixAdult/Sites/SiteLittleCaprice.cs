...
namespace Jellyfin.Plugin.PhoenixAdult.Sites
{
    ...
    {
        public string Name => "Little Caprice";
        public string DefaultUrl => "https://www.littlecaprice.com/";
        public List<string> AlternativeUrls => new List<string>();

        public Regex SceneUrlRegex => new Regex(@"(?<baseUrl>https?://www\.littlecaprice\.com/video/)(?<id>.*?)", RegexOptions.Compiled | RegexOptions.IgnoreCase);
        public Regex SceneIdRegex => new Regex(@"(?<baseUrl>https?://www\.littlecaprice\.com/video/)(?<id>.*?)", RegexOptions.Compiled | RegexOptions.IgnoreCase);
