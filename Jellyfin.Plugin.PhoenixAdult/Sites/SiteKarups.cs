...
namespace PhoenixAdult.Sites
{
    public class SiteKarups : IProviderBase
    {
        ...
        public async Task<List<RemoteSearchResult>> Search(int[] siteNum, string searchTitle, DateTime? searchDate, CancellationToken cancellationToken)
        {
            ...
            var doc = await HTML.ElementFromURL(searchUrl, cancellationToken, null, this.GetCookies());

            var actressLink = doc.SelectSingleNode("//div[@class='item-inside']//a");
            if (actressLink == null)
            {
                return new List<RemoteSearchResult>();
            }

            var actressPageUrl = actressLink.GetAttributeValue("href", string.Empty);
            doc = await HTML.ElementFromURL(actressPageUrl, cancellationToken, null, this.GetCookies());
        ...
        public async Task<MetadataResult<BaseItem>> Update(int[] siteNum, string[] sceneID, CancellationToken cancellationToken)
        {
            ...
            var doc = await HTML.ElementFromURL(sceneUrl, cancellationToken, null, this.GetCookies());
