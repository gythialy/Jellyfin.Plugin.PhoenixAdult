...
namespace PhoenixAdult.Sites
{
    public class Network18 : IProviderBase
    {
        ...
        public async Task<List<RemoteSearchResult>> Search(int[] siteNum, string searchTitle, DateTime? searchDate, CancellationToken cancellationToken)
        {
            ...
            var searchResults = await this.GetDataFromAPI(SearchQuery, "query", searchTitle, siteNum, cancellationToken);
        ...
        public async Task<MetadataResult<BaseItem>> Update(int[] siteNum, string[] sceneID, CancellationToken cancellationToken)
        {
            ...
            var detailsPageElements = await this.GetDataFromAPI(FindVideoQuery, "videoId", videoId, siteNum, cancellationToken);
            ...
            foreach (var actorLink in sceneData["talent"])
            {
                ...
                var actorPhotoData = await this.GetDataFromAPI(AssetQuery, "paths", actorPhotoPaths, siteNum, cancellationToken);
        ...
        public async Task<IEnumerable<RemoteImageInfo>> GetImages(int[] siteNum, string[] sceneID, BaseItem item, CancellationToken cancellationToken)
        {
            ...
            var imagesData = await this.GetDataFromAPI(AssetQuery, "paths", imagePaths, siteNum, cancellationToken);
