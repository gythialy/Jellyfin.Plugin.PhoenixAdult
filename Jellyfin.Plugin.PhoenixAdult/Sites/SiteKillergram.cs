...
namespace Jellyfin.Plugin.PhoenixAdult.Sites
{
    ...
    {
        public string Name => "Killergram";
        public string DefaultUrl => "https://www.killergram.com/";
        public List<string> AlternativeUrls => new List<string>();

        public Regex SceneUrlRegex => new Regex(@"(?<baseUrl>https?://www\.killergram\.com/video/)(?<id>.*?)", RegexOptions.Compiled | RegexOptions.IgnoreCase);
        public Regex SceneIdRegex => new Regex(@"(?<baseUrl>https?://www\.killergram\.com/video/)(?<id>.*?)", RegexOptions.Compiled | RegexOptions.IgnoreCase);
