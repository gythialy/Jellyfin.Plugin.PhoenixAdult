...
namespace PhoenixAdult.Sites
{
    public class SiteHotwifeXXX : IProviderBase
    {
        ...
        public async Task<MetadataResult<BaseItem>> Update(int[] siteNum, string[] sceneID, CancellationToken cancellationToken)
        {
            ...
            movie.Overview = detailsPageElements.SelectSingleNode("//div[@class='dvdDescription']/p")?.InnerText.Replace("description: ", "").Trim();
            ...
            if (actorNodes != null)
            {
                ...
                foreach (var actor in actorNodes)
                {
                    ...
                    if(actorHttp.IsOK)
                    {
                        ...
                        actorPhotoUrl = actorPage.SelectSingleNode("//div[@class='modelBioPic']/img")?.GetAttributeValue("src0_3x", "");
                    }
        ...
        public async Task<IEnumerable<RemoteImageInfo>> GetImages(int[] siteNum, string[] sceneID, BaseItem item, CancellationToken cancellationToken)
        {
            ...
            if(posterNode != null)
                images.Add(new RemoteImageInfo { Url = posterNode.GetAttributeValue("src", ""), Type = ImageType.Primary });
