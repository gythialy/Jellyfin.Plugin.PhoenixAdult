...
namespace Jellyfin.Plugin.PhoenixAdult.Sites
{
    ...
    {
        public string Name => "LegalPorno";
        public string DefaultUrl => "https://www.legalporno.com/";
        public List<string> AlternativeUrls => new List<string>();

        public Regex SceneUrlRegex => new Regex(@"(?<baseUrl>https?://www\.legalporno\.com/watch/)(?<id>.*?)", RegexOptions.Compiled | RegexOptions.IgnoreCase);
        public Regex SceneIdRegex => new Regex(@"(?<baseUrl>https?://www\.legalporno\.com/watch/)(?<id>.*?)", RegexOptions.Compiled | RegexOptions.IgnoreCase);
