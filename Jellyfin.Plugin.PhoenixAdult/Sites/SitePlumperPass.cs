...
namespace PhoenixAdult.Sites
{
    public class SitePlumperPass : IProviderBase
    {
        ...
        movie.Overview = doc.SelectSingleNode(@"//div[contains(@class, ""vidinfo"")]/p")?.InnerText.Trim();
        movie.AddStudio("PlumperPass");

        var dateNode = doc.SelectSingleNode(@"//h3[@class=""releases""]//br/preceding-sibling::text()");
