    ...
    public class SiteMeanaWolf : IProviderBase
    {
        public async Task<List<RemoteSearchResult>> Search(int[] siteNum, string searchTitle, DateTime? searchDate, CancellationToken cancellationToken)
        {
            ...
            if (http.IsOK)
            {
                ...
                var searchNodes = doc.DocumentNode.SelectNodes("//div[@class='videoBlock']");
                if (searchNodes == null)
                {
                    return result;
                }
                ...
                {
                    var titleNode = searchResult.SelectSingleNode("./p/a");
                    if (titleNode == null)
                    {
                        continue;
                    }
                    ...
                    var image = searchResult.SelectSingleNode(".//img[@class='video_placeholder']")?.GetAttributeValue("src", string.Empty) ?? string.Empty;
