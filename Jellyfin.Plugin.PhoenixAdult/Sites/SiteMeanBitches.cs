...
{
    public class SiteMeanBitches : SiteBase
    {
        public override string Name => "Mean Bitches";
        public override string DefaultUrl => "https://www.meanbitches.com/";
        public override List<string> AlternativeUrls => new List<string>();

        public override Regex SceneUrlRegex => new Regex(@"(?<baseUrl>https?://www\.meanbitches\.com/scene/)(?<id>.*?)", RegexOptions.Compiled | RegexOptions.IgnoreCase);
        public override Regex SceneIdRegex => new Regex(@"(?<baseUrl>https?://www\.meanbitches\.com/scene/)(?<id>.*?)", RegexOptions.Compiled | RegexOptions.IgnoreCase);
